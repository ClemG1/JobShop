...
public class Main {
    ...
    static {
        ...
        solvers.put("glouton", new GloutonSolver("SPT"));
        solvers.put("gloutonSPT", new GloutonSolver("SPT"));
        solvers.put("gloutonLPT", new GloutonSolver("LPT"));
        solvers.put("gloutonSRPT", new GloutonSolver("SRPT"));
